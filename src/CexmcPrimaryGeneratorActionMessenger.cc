...
{
    fwhmPosX = new G4UIcmdWithADoubleAndUnit( "/cexmc/gun/fwhmPosX", this );
    ...
    fwhmPosY = new G4UIcmdWithADoubleAndUnit( "/cexmc/gun/fwhmPosY", this );
    ...
    fwhmAngleX = new G4UIcmdWithADoubleAndUnit( "/cexmc/gun/fwhmAngleX", this );
    ...
    fwhmAngleY = new G4UIcmdWithADoubleAndUnit( "/cexmc/gun/fwhmAngleY", this );
    ...
    fwhmMomentumAmp = new G4UIcmdWithADouble( "/cexmc/gun/fwhmMomentumAmp",
                                              this );
